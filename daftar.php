...
if (isset($_POST['daftar'])) {
    ...
    $upload = move_uploaded_file($lokasi, "./assets/img/foto-user/" . $foto);
        ...
        ?>
            <script>
                alert("Akun Berhasil didaftarkan!, Mohon tunggu admin untuk memvalidasi");
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">PB. SALMAIRA</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2"> Daftar Petugas 🚀</h4>
              <p class="mb-4">Silakan isi data diri Anda</p>
              ...
              <form id="" class="mb-3" action="" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="status" value="nonvalid">

                <button class="btn btn-primary d-grid w-100" name="daftar" value="Daftar">Daftar</button>
              </form>
