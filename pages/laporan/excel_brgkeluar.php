...
header("Content-Disposition: attachment; filename=Laporan Barang Keluar(" . date('d-m-Y') . ").xls");
...
<div class="card-body">
    <h2 class="card-title">
        <center>Rekap Barang Keluar</center>
    </h2>
    <h2 class="card-title">
        <center>PB. SALMAIRA GEMILANG</center>
    </h2>
    <h2 class="card-title">
        <center>Bulan <?= $blnn ?> Tahun <?= $thn ?></center>
    </h2>
    <div class="tampung1">
